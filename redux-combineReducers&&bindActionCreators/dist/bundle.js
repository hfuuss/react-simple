...
var ADDTODOS = exports.ADDTODOS = "ADDTODOS_TODOLIST";
var CHANGETODO = exports.CHANGETODO = "CHANGETODO_TODOLIST";
var DELTODO = exports.DELTODO = " DELTODO_TODOLIST";
var CHANGESHOW = exports.CHANGESHOW = "CHANGESHOW_TODOLIST";
...
var ADD = exports.ADD = "ADD_COUNTER";
var MINUS = exports.MINUS = "MINUS_COUNTER";
var CHENG = exports.CHENG = "CHENG_COUNTER";
var CHU = exports.CHU = "CHU_COUNTER";
var PINGFANG = exports.PINGFANG = "PINGFANG_COUNTER";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(45);
...
*/
var ba=__webpack_require__(2),ea=__webpack_require__(1),m=__webpack_require__(15),A=__webpack_require__(4),C=__webpack_require__(3),fa=__webpack_require__(16),ha=__webpack_require__(17),ja=__webpack_require__(18),ka=__webpack_require__(6);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(11), __webpack_require__(38)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(48);
...
var initObj = {
    "todos": [{ "id": 1, "title": "洗脸", "done": false }, { "id": 2, "title": "刷牙", "done": false }, { "id": 3, "title": "早餐", "done": true }, { "id": 4, "title": "复习", "done": false }, { "id": 5, "title": "睡觉", "done": false }],
    "show": "All" //All,YIdone,WEIdone
};

exports.default = function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initObj;
    var action = arguments[1];


    if (action.type == _TODOLIST.ADDTODOS) {
        return _extends({}, state, {
            "todos": [].concat(_toConsumableArray(state.todos), [{
                "id": state.todos.reduce(function (a, b) {
    ...
    } else if (action.type == _TODOLIST.CHANGETODO) {
        return _extends({}, state, {
            "todos": state.todos.map(function (item) {
                if (item.id != action.id) return item;
                return _extends({}, item, _defineProperty({}, action.k, action.v));
            })
        });
    } else if (action.type == _TODOLIST.DELTODO) {
        return _extends({}, state, {
            "todos": state.todos.filter(function (item) {
                return item.id != action.id;
            })
        });
    } else if (action.type == _TODOLIST.CHANGESHOW) {
        return _extends({}, state, {
            "show": action.show
        });
    }
...
exports.default = function () {
    ...
    if (action.type == _COUNTER.ADD) {
        return _extends({}, state, {
            "num": state.num + action.v
        });
    } else if (action.type == _COUNTER.MINUS) {
        return _extends({}, state, {
            "num": state.num - 1
        });
    } else if (action.type == _COUNTER.CHENG) {
        return _extends({}, state, {
            "num": state.num * 2
        });
    } else if (action.type == _COUNTER.CHU) {
        return _extends({}, state, {
            "num": state.num / 2
        });
    } else if (action.type == _COUNTER.PINGFANG) {
        return _extends({}, state, {
...
var _TodoHd = __webpack_require__(68);

var _TodoHd2 = _interopRequireDefault(_TodoHd);

var _TodoBd = __webpack_require__(69);

var _TodoBd2 = _interopRequireDefault(_TodoBd);

var _TodoFt = __webpack_require__(71);
...
var TodoHd = function (_React$Component) {
    ...
    function TodoHd(props) {
        _classCallCheck(this, TodoHd);

        return _possibleConstructorReturn(this, (TodoHd.__proto__ || Object.getPrototypeOf(TodoHd)).call(this, props));
    }
    ...
    _createClass(TodoHd, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("input", { type: "text", ref: "titleTxt" }),
                _react2.default.createElement(
                    "button",
                    { onClick: function onClick() {
                            if (_this2.refs.titleTxt.value == "") return;
                            _this2.props.addTodos(_this2.refs.titleTxt.value);
                            _this2.refs.titleTxt.value = "";
                        } },
                    "\u6DFB\u52A0"
                )
            );
...
exports.default = (0, _reactRedux.connect)(null, function (dispatch) {
    return {
        addTodos: function addTodos(title) {
            dispatch({ "type": _TODOLIST.ADDTODOS, title: title });
        }
    };
})(TodoHd);
...
var _TodoItem = __webpack_require__(70);
            ...
            return _react2.default.createElement(
                ...
                todos.map(function (item) {
                    return _react2.default.createElement(_TodoItem2.default, {
                        key: item.id,
                        item: item,
                        changeTodo: _this2.props.changeTodo.bind(_this2),
                        delTodo: _this2.props.delTodo.bind(_this2)
                    });
                })
            );
        }
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    return {
        changeTodo: function changeTodo(id, k, v) {
            dispatch({ "type": _TODOLIST.CHANGETODO, id: id, k: k, v: v });
        },
        delTodo: function delTodo(id) {
            dispatch({ "type": _TODOLIST.DELTODO, id: id });
        }
    };
})(TodoBd);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", {
                        ...
                        onChange: function onChange(e) {
                            _this2.props.changeTodo(_this2.props.item.id, "done", e.target.checked);
                        }
                    }),
                    this.state.onEdit ? _react2.default.createElement("input", {
                        type: "text",
                        defaultValue: this.props.item.title,
                        onBlur: function onBlur(e) {
                            _this2.props.changeTodo(_this2.props.item.id, "title", e.target.value);
                            _this2.setState({
                                "onEdit": false
                            });
                        }
                ...
                _react2.default.createElement(
                    "button",
                    { onClick: function onClick() {
                            _this2.props.delTodo(_this2.props.item.id);
                        } },
                    "\u5220\u9664"
                )
            );
...
var TodoFt = function (_React$Component) {
    _inherits(TodoFt, _React$Component);

    function TodoFt() {
        _classCallCheck(this, TodoFt);

        return _possibleConstructorReturn(this, (TodoFt.__proto__ || Object.getPrototypeOf(TodoFt)).call(this));
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    "\u6761\u4E8B\u4EF6, \u505A\u5B8C\u4E86",
                    this.props.todos.filter(function (item) {
                        return item.done;
                    }).length,
                    "\u6761\u4E8B\u4EF6, \u6CA1\u505A\u5B8C\u4E86",
                    this.props.todos.filter(function (item) {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        {
                            onClick: function onClick() {
                                _this2.props.changeShow("YIdone");
                            },
                            className: (0, _classnames2.default)({
                    ...
                    _react2.default.createElement(
                        ...
                        {
                            onClick: function onClick() {
                                _this2.props.changeShow("WEIdone");
                            },
                            className: (0, _classnames2.default)({
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    return {
        changeShow: function changeShow(show) {
            dispatch({ "type": _TODOLIST.CHANGESHOW, show: show });
        }
    };
})(TodoFt);
...
var _counterActions = __webpack_require__(74);
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    return {
        test: (0, _redux.bindActionCreators)(counterActions, dispatch)
    };
})(Counter);
...
exports.pingfang = exports.chu = exports.cheng = exports.minus = exports.add = undefined;

var _COUNTER = __webpack_require__(14);

var add = exports.add = function add(v) {
  return { "type": _COUNTER.ADD, v: v };
};
var minus = exports.minus = function minus() {
  return { "type": _COUNTER.MINUS };
};
var cheng = exports.cheng = function cheng() {
  return { "type": _COUNTER.CHENG };
};
var chu = exports.chu = function chu() {
  return { "type": _COUNTER.CHU };
};
var pingfang = exports.pingfang = function pingfang() {
  return { "type": _COUNTER.PINGFANG };
};
